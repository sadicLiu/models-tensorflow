...
# TEST_IMAGE_PATHS_CAT = [ os.path.join('/home/liuhy/Pictures', 'cat{}.jpg'.format(i)) for i in range(1, 4) ]
TEST_IMAGE_PATHS_DOG = [os.path.join('/home/liuhy/Pictures', 'dog{}.jpg'.format(i)) for i in range(1, 2)]
...
for image_path in TEST_IMAGE_PATHS:
    ...
    save_path = '/home/liuhy/Downloads/test.jpg'
