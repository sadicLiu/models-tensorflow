...
scripts/create_cowface_record.sh
"""
...
flags = tf.app.flags
flags.DEFINE_string('data_dir', '', 'Root directory to raw COWFACE dataset.')
flags.DEFINE_string('set', 'train', 'Convert training set, validation set or '
                                    'merged set.')
flags.DEFINE_string('annotations_dir', 'Annotations',
                    '(Relative) path to annotations directory.')
flags.DEFINE_string('output_path', '', 'Path to output TFRecord')
flags.DEFINE_string('label_map_path', 'data/cowface_label_map.pbtxt',
...
def main(_):
    ...
    # print(label_map_dict)   # {u'dog': 1}

    logging.info('Reading from COWFACE dataset.')
    examples_path = os.path.join(data_dir, 'ImageSets', FLAGS.set + '.txt') # 指定生成的数据集
